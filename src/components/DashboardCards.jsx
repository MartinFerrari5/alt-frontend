...
const DashboardCards = () => {
    ...
    return (
        <div className="grid grid-cols-4 gap-9">
            ...
            {/* In Progress Tasks */}
            <DashboardCard
                icon={<FaSpinner className="text-2xl text-brand-process animate-spin" />} // Use FaSpinner icon with animation
            ...
            {/* Completed Tasks */}
            <DashboardCard
                icon={<FaCheckCircle className="text-2xl text-brand-custom-green" />} // Use FaCheckCircle icon
