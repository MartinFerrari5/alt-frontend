...
const schema = z
  .object({
    ...
    old_password: z.string().min(1, { message: "La contraseña antigua es obligatoria" }),
    new_password: z
      .string()
    ...
    confirm_new_password: z.string().min(1, { message: "Confirma la nueva contraseña" }),
  })
...
const ChangePassword = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-md mx-auto p-4">
      ...
      <div className="mb-6">
        <label htmlFor="confirm_new_password" className="block mb-1 font-medium">
