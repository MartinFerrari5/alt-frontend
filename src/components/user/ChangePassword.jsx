...
const ChangePassword = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-md p-6 bg-white shadow rounded">
      ...
      <div className="mb-5">
        <label htmlFor="old_password" className="mb-2 block text-sm font-medium text-gray-700">
          Contraseña antigua
        </label>
        <input
          type="password"
      ...
      <div className="mb-6">
        <label htmlFor="confirm_new_password" className="mb-2 block text-sm font-medium text-gray-700">
      ...
      <button
        ...
        className="flex w-full items-center justify-center rounded bg-blue-600 px-4 py-3 text-white font-semibold transition hover:bg-blue-700 disabled:opacity-75"
      >
        {isSubmitting && (
