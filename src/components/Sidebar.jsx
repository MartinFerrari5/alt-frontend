...
const Sidebar = () => {
    ...
    return (
        <div className="relative flex h-screen">
            <div
                className={`absolute z-50 flex h-full w-72 min-w-72 transform flex-col justify-between bg-white transition-transform lg:relative lg:translate-x-0 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
            >
                <div>
                        ...
                        {role === "admin" && (
                            <div className="relative">
                                ...
                                >
                                    Admin
                                    <svg
                                        className={`ms-3 h-2.5 w-2.5 transition-transform ${isDropdownOpen ? "rotate-180" : ""}`}
                                        aria-hidden="true"
